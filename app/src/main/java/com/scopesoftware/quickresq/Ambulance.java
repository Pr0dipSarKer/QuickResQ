...
public class Ambulance extends AppCompatActivity {
    ...
    public static String current_location1="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "https://www.google.com/maps/search/ambulance+in+" +current_location1;
        Log.d("fayaj", url);
        webView.loadUrl(url);
    ...
    private void handleTelLink(String url) {
        if (ContextCompat.checkSelfPermission(Ambulance.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Ambulance.this, new String[]{android.Manifest.permission.CALL_PHONE}, CALL_PERMISSION_REQUEST_CODE);
        } else {
            startCallIntent(url);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == CALL_PERMISSION_REQUEST_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(Ambulance.this, "Call permission denied", Toast.LENGTH_SHORT).show();
            }
        }
    }
}